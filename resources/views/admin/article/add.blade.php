    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="{{url('admin/article')}}" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <tr>
                                <th>文章标题：</th>
                                <td><input class="common-text" name="art_title" size="50" value="" type="text"></td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input class="art_thumb" name="art_thumb"  value="" type="text">
                            ...
                            <tr>
                                <th></th>
                                <td><img src="" alt="" id="art_thumb_img" style="max-width: 350px;max-height: 100px;"></td>
                            </tr>
                            <tr>
                                <th>作者：</th>
                                <td><input class="common-text" name="art_edtor"  value="" type="text"></td>
                            </tr>
                            <tr>
                                <th>分类关键词：</th>
                                <td><input class="art_tag" name="art_tag"  value="" type="text"></></td>
                            </tr>
                            <tr>
                                <th>分类描述：</th>
                                <td><textarea name="art_description" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="5"></textarea></td>
                            </tr>
                            <tr>
                                <th>文章内容：</th>
                                <td>
                                    ...
                                    <script id="editor" type="text/plain" name="art_content" style="width:960px;height:500px;"></script>
